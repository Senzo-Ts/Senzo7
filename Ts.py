...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;93mStay Home Message from Senzo' )
                ...
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mGood boy' )
...
def super():
	...
	print "\033[1;96m--\033[1;92m> \033[1;92m2.\x1b[1;91mClone From SA D Link Public Frendlist..."
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mBlackMafia\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By Senzomkhungo--тАвтЧИтАв---┬╗" #Dev:Senzo_mkhungo
...
: \033[1;93m.Senzomkhungo.... \033[1;93m :
тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд.' 
                whatsapp Num
               """+27611064513"""
